    ...
    <DropdownMenu>
      ...
      >
        <Avatar size="sm">
          ...
          <AvatarFallback className="bg-cyan-300/10 text-[9px] font-bold text-cyan-700 dark:text-cyan-200">{initials(user)}</AvatarFallback>
        </Avatar>
        <span className="sr-only">Account</span>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-64 border-border bg-popover/95 p-1.5 backdrop-blur-xl">
        <DropdownMenuGroup>
          <DropdownMenuLabel className="flex items-center gap-2 px-2 py-2">
            <span className="grid size-8 place-items-center rounded-lg bg-accent"><UserRound className="size-4 text-cyan-700 dark:text-cyan-300" /></span>

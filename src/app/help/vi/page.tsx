      ...
      <Section id='inspect' title='4. Chỉnh sửa khối & đường nối'>
        ...
        <ul className='list-disc space-y-1.5 pl-5'>
          ...
          <li>
            ...
            smooth-step), chiều chạy (xuôi / ngược / cả hai), mũi tên hai đầu, độ dày nét, cỡ vật thể hiệu ứng, số lượng vật thể chạy trên đường nối, mật độ hoạ tiết, độ sáng quầng neon, độ lệch pha và tốc độ chuyển động — cùng nút <strong>Delete</strong>.
          </li>
        </ul>
        <p>

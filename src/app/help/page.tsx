      ...
      <Section id='inspect' title='4. Editing nodes & edges'>
        ...
        <ul className='list-disc space-y-1.5 pl-5'>
          ...
          <li>
            ...
            smooth-step), direction (forward / reverse / both), start and end markers (arrowheads), line width, effect object size, the number of objects travelling the line, pattern density, glow strength, phase offset, and animation speed — plus <strong>Delete</strong>.
          </li>
        </ul>
        <p>
